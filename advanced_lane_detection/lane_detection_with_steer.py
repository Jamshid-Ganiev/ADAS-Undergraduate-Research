...
# Function to read the input video
def read_vid():
    img = cv2.VideoCapture("drive.mp4")
    return img
...
out = cv2.VideoWriter('drive_result.mp4', fourcc, 20.0, (1280, 720) )  # Adjust the frame size (1280, 720) to match your input video
